                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($promo['periode'])) : ?>
                                            <?= date('d-m-Y', strtotime($promo['periode']['tgl_mulai'])) ?>
                                            s/d
                                            <?= date('d-m-Y', strtotime($promo['periode']['tgl_selesai'])) ?>
                                        <?php else : ?>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('modules/pengaturan-promo/' . $promo['kode_promo'] . '/detail') ?>"
                                            class="btn btn-info btn-sm"
                                            title="Detail">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="<?= base_url('modules/pengaturan-promo/' . $promo['kode_promo'] . '/edit') ?>" class="btn btn-warning btn-sm">
